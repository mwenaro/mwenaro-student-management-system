...
$configs['students']['all']="SELECT studentId,first_name,middle_name,last_name,gen,dob,religion,form,adm,active FROM students WHERE active IS  1 AND isDeleted IS 0 ";
 ...
 *                        TRS
*******************************************************************************************************/
$configs['teachers']['all']="SELECT teacherId,title,first_name,last_name,gen,type,phone,staff_code,sub1,sub2 FROM teachers WHERE isDeleted IS NOT 1 AND isActive is 1";

...
//        $t = 'F' . $this->student->form . 'T' . TERM;
        ...
        $this->graphY(
            $this->graphFrameLeftX, $this->graphFrameTopY, $this->w * 0.6, $this->graphFrameHeight,
            array(
                'data' => array(
        ...
        $this->graphY(
            ($this->graphFrameLeftX + $this->w * 0.58), $this->graphFrameTopY, $this->w * 0.35, $this->graphFrameHeight,
            array(
